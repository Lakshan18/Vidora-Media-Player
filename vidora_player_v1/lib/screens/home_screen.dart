...
//     _player.streams.playlist.listen((event) {
//       // Handle playlist changes
//     });

//     _player.streams.playing.listen((event) {
//       setState(() => _isPlaying = event);
//     });

//     _player.streams.volume.listen((event) {
//       setState(() => _volume = event);
//     });

//     _player.streams.muted.listen((event) {
//       setState(() => _isMuted = event);
//     });
...
class _HomeScreenState extends State<HomeScreen>
  ...
  void initState() {
    ...
    _player.streams.isMuted.listen((event) {
      if (mounted) setState(() => _isMuted = event);
    });
